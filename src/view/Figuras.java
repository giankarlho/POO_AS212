...
public class Figuras extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcbFiguras.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione", "Círculo", "Cuadrado", "Triángulo", "Pentágono" }));
        jcbFiguras.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcbFigurasActionPerformed(evt);
            }
        });
...
//        jpnFiguras.repaint();
    ...
    private void jcbFigurasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcbFigurasActionPerformed
//        System.out.println("Selección Item: " + jcbFiguras.getSelectedItem().toString());
//        System.out.println("Selección Index: " + jcbFiguras.getSelectedIndex());        
        int index = jcbFiguras.getSelectedIndex();
        switch (index) {
            case 1:
                jpCirculo circulo = new jpCirculo();
                circulo.setSize(700, 500);
    ...
    }//GEN-LAST:event_jcbFigurasActionPerformed
